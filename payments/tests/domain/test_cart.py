...
def test_cart_add_cart_items():
    ...
    test_product_price = ProductPrice(currency=test_currency, price=Decimal(100.10), product=test_product)
    
    test_cart_item = CartItem(product=test_product, product_price=test_product_price)
    test_product_2 = Product("test name 2", True)
    test_product_price_2 = ProductPrice(currency=test_currency, price=Decimal(101.10), product=test_product_2)
    
    test_cart_item_2 = CartItem(product=test_product_2, product_price=test_product_price_2)
